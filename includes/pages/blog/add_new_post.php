<div class="card">
    <div class="card-body">
        ...
        <form action="./includes/scripts/blogs/addnewpost.php" class="forms-sample" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" id="desc" name="desc" placeholder="Post Description"></textarea>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-primary me-2">Add New Post</button>
